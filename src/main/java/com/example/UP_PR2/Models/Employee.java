...
public class Employee {
    ...
    public boolean hasPost(){return this.post.equals(null);}

    public Employee() { }

    public Employee(String username, String password, Boolean active, Set<Role> roles, String surname, String name, String middleName, int number_passport, int serial_passport, Date birthday,String phone, Post post) {
